 ...
 */
final class Version20220203110412 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE image_work CHANGE work_id work_id INT DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE image_work CHANGE work_id work_id INT NOT NULL, CHANGE alt alt VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE src src VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
